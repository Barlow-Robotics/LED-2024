...
void loop() {
  ...
  bool BlueAlliance = (currentMode & 0b00000001) == 0b00000000;
  bool RedAlliance = (currentMode & 0b00000001) == 0b00000001; //hubv if binary data at 10 (2) than red
  bool Enabled = (currentMode & 0b00000010) == 0b00000010;
  bool NoteLoaded = currentMode & 0b00000100 == 0b00000100;
  bool isShooting = currentMode & 0b00001000 == 0b00001000;
  bool Auto = currentMode & 0b00010000 == 0b00010000;
  bool Default = currentMode & 0b00100000 == 0b00100000; // default
  bool isClimbing = currentMode & 0b01000000 == 0b0100000;
